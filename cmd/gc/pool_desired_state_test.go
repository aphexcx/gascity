...
func TestComputePoolDesiredStates_ResumeBeatsNew(t *testing.T) {
	...
	result := ComputePoolDesiredStates(cfg, work, nil, sessionInfosFromBeads(sessions), scaleCheck)
...
func TestComputePoolDesiredStates_MaxCapsTotal(t *testing.T) {
	...
	result := ComputePoolDesiredStates(cfg, nil, nil, nil, scaleCheck)
...
func TestComputePoolDesiredStates_TerminalProviderErrorSessionsDoNotBlockNewDemand(t *testing.T) {
	...
	result := ComputePoolDesiredStates(cfg, work, nil, sessionInfosFromBeads([]beads.Bead{stale}), map[string]int{"claude": 1})
...
func TestComputePoolDesiredStates_TraceListsActiveCapacityBlockers(t *testing.T) {
	...
	result := computePoolDesiredStates(cfg, work, nil, sessionInfosFromBeads(sessions), map[string]int{"claude": 1}, nil, nil, trace)
...
func TestComputePoolDesiredStates_ManualSessionDoesNotConsumeSingletonNewDemand(t *testing.T) {
	...
	result := ComputePoolDesiredStates(cfg, nil, nil, sessionInfosFromBeads([]beads.Bead{manual}), map[string]int{"claude": 1})
...
func TestComputePoolDesiredStates_NamedSessionBeadSkipsPoolResume(t *testing.T) {
	...
	result := ComputePoolDesiredStates(cfg, work, nil, sessionInfosFromBeads([]beads.Bead{namedBead}), nil)
...
func TestComputePoolDesiredStates_UnassignedRoutedBeadDoesNotCreateDemand(t *testing.T) {
	...
	result := ComputePoolDesiredStates(cfg, work, nil, nil, map[string]int{"rig/claude": 0})
...
func TestComputePoolDesiredStates_CapsNewDemandBeforeMaterializingRequests(t *testing.T) {
	...
	result := computePoolDesiredStates(cfg, work, nil, sessionInfosFromBeads(sessions), map[string]int{"claude": 10}, nil, nil, trace)
...
func TestComputePoolDesiredStates_NoDemandNoAssignment(t *testing.T) {
	...
	result := ComputePoolDesiredStates(cfg, nil, nil, nil, map[string]int{"claude": 0})
...
func TestComputePoolDesiredStates_AssignedSessionsDoNotConsumeNewDemand(t *testing.T) {
	...
	result := ComputePoolDesiredStates(cfg, work, nil, sessionInfosFromBeads(sessions), map[string]int{"claude": 5})
...
func TestComputePoolDesiredStates_InFlightNewSessionsConsumeScaleDemand(t *testing.T) {
	...
	result := ComputePoolDesiredStates(cfg, nil, nil, sessionInfosFromBeads(sessions), scaleCheck)
...
func TestComputePoolDesiredStates_DoesNotResumeSessionAcrossExplicitRouteMismatch(t *testing.T) {
	...
	result := ComputePoolDesiredStates(cfg, work, nil, sessionInfosFromBeads([]beads.Bead{session}), nil)
...
func TestComputePoolDesiredStates_InFlightPredicateBranches(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := ComputePoolDesiredStates(cfg, nil, nil, sessionInfosFromBeads([]beads.Bead{tt.session}), map[string]int{"claude": 1})
...
func TestComputePoolDesiredStates_StaleCreatingBeadStillConsumesNewDemand(t *testing.T) {
	...
	result := ComputePoolDesiredStates(cfg, nil, nil, sessionInfosFromBeads([]beads.Bead{stale}), map[string]int{"claude": 1})
...
func TestComputePoolDesiredStates_InFlightSelectionRespectsCapsInStableOrder(t *testing.T) {
	...
	result := ComputePoolDesiredStates(cfg, nil, nil, sessionInfosFromBeads(sessions), map[string]int{"claude": 10})
...
func TestComputePoolDesiredStates_InFlightDemandRecordsTrace(t *testing.T) {
	...
	result := computePoolDesiredStates(cfg, nil, nil, sessionInfosFromBeads(sessions), map[string]int{"claude": 5}, nil, nil, trace)

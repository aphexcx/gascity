...
func TestMoleculeAutocloseClosesRootWhenAllStepsClosed(t *testing.T) {
	...
	doMoleculeAutocloseWith(store, "", autocloseGate{}, events.Discard, stepA.ID, &out1)
	...
	doMoleculeAutocloseWith(store, "", autocloseGate{}, events.Discard, stepB.ID, &out2)
...
func TestMoleculeAutocloseIgnoresNonStepCloses(t *testing.T) {
	...
	doMoleculeAutocloseWith(store, "", autocloseGate{}, events.Discard, task.ID, &out)
...
func TestMoleculeAutocloseIgnoresStepWithoutParent(t *testing.T) {
	...
	var out bytes.Buffer
	doMoleculeAutocloseWith(store, "", autocloseGate{}, events.Discard, orphan.ID, &out)
	if out.Len() != 0 {
...
func TestMoleculeAutocloseIgnoresParentNotMolecule(t *testing.T) {
	...
	var out bytes.Buffer
	doMoleculeAutocloseWith(store, "", autocloseGate{}, events.Discard, step.ID, &out)
...
func TestMoleculeAutocloseRespectsTombstone(t *testing.T) {
	...
	var out bytes.Buffer
	doMoleculeAutocloseWith(store, "", autocloseGate{}, events.Discard, stepB.ID, &out)
	r, _ := store.Get(root.ID)
	if r.Status != "closed" {
...
func TestMoleculeAutocloseNestedStepUsesRootBeadIDMetadata(t *testing.T) {
	...
	var out bytes.Buffer
	doMoleculeAutocloseWith(store, "", autocloseGate{}, events.Discard, nested.ID, &out)
	r, _ := store.Get(root.ID)
	if r.Status != "closed" {
...
func TestMoleculeAutocloseLeavesOpenWhenNestedDescendantStillOpen(t *testing.T) {
	...
	var out bytes.Buffer
	doMoleculeAutocloseWith(store, "", autocloseGate{}, events.Discard, nestedClosed.ID, &out)
	r, _ := store.Get(root.ID)
	if r.Status == "closed" {
...
func TestMoleculeAutocloseClosesWorkflowRootOnSourceBeadClose(t *testing.T) {
	...
	var out bytes.Buffer
	doMoleculeAutocloseWith(store, "", autocloseGate{}, events.Discard, work.ID, &out)
...
func TestMoleculeAutocloseSourceCloseScopesToStoreRef(t *testing.T) {
	...
	_ = store.Close(work.ID)
	var out bytes.Buffer
	doMoleculeAutocloseWith(store, "rig:alpha", autocloseGate{}, events.Discard, work.ID, &out)
...
func TestMoleculeAutocloseEmitsMoleculeResolvedWithSessionAttribution(t *testing.T) {
	...
	rec := events.NewFake()
	var out bytes.Buffer
	doMoleculeAutocloseWith(store, "", autocloseGate{}, rec, step.ID, &out)

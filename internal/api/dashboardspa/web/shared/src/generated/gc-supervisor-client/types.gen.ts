...
export type InboundDelivery = {
    ...
    members?: Array<InboundDeliveryMember> | null;
    receipt_id: string;
    status: string;
};

export type InboundDeliveryMember = {
    delivered_bytes: number;
    digest: string;
    error?: string;
    expected_bytes: number;
...
export type InboundDuplicateEventPayload = {
    actor: string;
    conversation_id: string;
    provider: string;
    provider_message_id: string;
...
export type TypedEventStreamEnvelope = ({
    ...
    type: 'extmsg.inbound_duplicate';
} & TypedEventStreamEnvelopeExtmsgInboundDuplicate) | ({
 ...
 */
export type TypedEventStreamEnvelopeExtmsgInboundDuplicate = {
    actor: string;
    depends_on_step_ids?: Array<string>;
    message?: string;
    payload: InboundDuplicateEventPayload;
    run_id?: string;
    seq: number;
    session_id?: string;
    step_id?: string;
...
export type TypedTaggedEventStreamEnvelope = ({
    ...
    type: 'extmsg.inbound_duplicate';
} & TypedTaggedEventStreamEnvelopeExtmsgInboundDuplicate) | ({
    type: 'extmsg.outbound';
 ...
 */
export type TypedTaggedEventStreamEnvelopeExtmsgInboundDuplicate = {
    actor: string;
    city: string;
    depends_on_step_ids?: Array<string>;
    message?: string;

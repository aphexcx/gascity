...
/**
 * Get v0 city by city name extmsg inbound receipts by receipt ID
 */
export const getV0CityByCityNameExtmsgInboundReceiptsByReceiptId = <ThrowOnError extends boolean = false>(options: Options<GetV0CityByCityNameExtmsgInboundReceiptsByReceiptIdData, ThrowOnError>) => (options.client ?? client).get<GetV0CityByCityNameExtmsgInboundReceiptsByReceiptIdResponses, GetV0CityByCityNameExtmsgInboundReceiptsByReceiptIdErrors, ThrowOnError>({ url: '/v0/city/{cityName}/extmsg/inbound/receipts/{receipt_id}', ...options });

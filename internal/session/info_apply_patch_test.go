...
var allProjectedMetadataKeys = []string{
	...
	beadmeta.StartResetOwedBeadIDMetadataKey, beadmeta.StartResetOwedStoreRefMetadataKey,
...
func oracleBaseBeads() []beads.Bead {
	...
	populated := map[string]string{
		...
		beadmeta.StartResetOwedBeadIDMetadataKey: "owed-tb", beadmeta.StartResetOwedStoreRefMetadataKey: "owed-ref",

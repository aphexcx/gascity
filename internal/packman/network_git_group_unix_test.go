...
func TestDefaultRunNetworkGitKillsDescendants(t *testing.T) {
	...
	// This test measures descendant death, not deadline latency. Give the
	// shell fixture time to start under parallel load; the bounded-call test
	// separately retains its 300ms deadline.
	networkGitTimeout = 2 * time.Second
